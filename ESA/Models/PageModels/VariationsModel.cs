...
namespace ESA.Models
{
    public class VariationsModel
    {
        ...
        public List<VariationsModel> GetVariationList()

        {
         ...
         //              VariationImage = ImageSource.FromResource("ESA.Resources.variationimage1.png", typeof(MarkupExtensions.ImageResourceExtension).GetTypeInfo().Assembly) },
                     new VariationsModel() { Name = "Sliding Tarsoconjunctival Flap Reconstruction" , Details = "Narrated demonstration: post tumour reconstruction of upper eyelid using sliding Uploaded 14th November 2017 - 5,217 Views",
                        ...
                        new VariationsModel() { Name = "Fornix Reconstruction with Omnigen" , Details = "Narrated reconstruction of inferior fornix using Ominigen Uploaded 11th June 2019 - 109 Views",
                            VariationImage = "variationImage3.png"},
                           new VariationsModel() { Name = "Nasofacial sulcus island Pedicle (V to Y) Flap" , Details = "Narrated advancement flap for reconstruction in periocular region Uploaded 27th October 2019 - 309 Views",
